 ...
 */
public abstract class RNAAbstractRenderer extends NodeAbstractRenderer {
    @Override
    ...
    public void setColourProperties(AdvancedContext2d ctx, ColourProfileType type) {
        type.setColourProfile(ctx, DiagramColours.get().PROFILE.getRna());
    }
    ...
    public void setTextProperties(AdvancedContext2d ctx, ColourProfileType type){
        ...
        type.setTextProfile(ctx, DiagramColours.get().PROFILE.getRna());
    }
}
